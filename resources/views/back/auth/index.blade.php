...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="auth_add('添加权限','{{ url('admin/auth/create') }}','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加权限</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg datatables">
        ...
        <th width="30">父级权限</th>
				<th width="60">权限名称</th>
				<th width="60">权限对应的方法</th>
				<th width="60">权限对应的控制器</th>
        <th width="50">权限对应的地址</th>
        <th width="50">是否作为菜单</th>
        <th width="50">添加时间</th>
				<th width="50">修改时间</th>
				<th width="40">操作</th>
			</tr>
...
$('.datatables').DataTable({
	...
	"createdRow":function(row,data,dataIndex){
		...
		$(row).children().eq(-1).html('<a title="编辑" href="javascript:;" onclick="auth_edit(\'权限编辑\',\'/admin/role/'+data.id+'/edit\',\'1\',\'1100\',\'500\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="auth_del(this,\''+data.id+'\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>');
	}
});
...
function auth_del(obj,id){
    ...
    $.post('/admin/auth/'+id,data,function(msg){
      if( msg.status ){
